...
def attack(char_name: str, char_class: str) -> str:
    """Отображает нанесенный урон."""
    if char_class == 'warrior':
        return (f'{char_name} нанёс урон противникуравный '
                f'{5 + randint(3, 5)}')
    if char_class == 'mage':
...
def defence(char_name: str, char_class: str) -> str:
    """Отображает заблокированный урон."""
    if char_class == 'warrior':
...
def choice_char_class() -> str:
    """Запускает начало игры и выбор класса."""
    approve_choice: str = ''
    char_class: str = ''
